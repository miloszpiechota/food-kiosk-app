...
- Restaurant administrators or staff managing orders

## Product Context
This project is being designed as a web application with a kiosk-focused user experience rather than a traditional desktop admin tool or a general food delivery app. The interface should be optimized for touch-friendly, guided ordering on a terminal screen.

## Portfolio Goal
This project is intended to be a strong junior full-stack portfolio piece. Its purpose is to demonstrate the ability to design and build a complete application from scratch, apply modern engineering practices, and show clear thinking about product structure, architecture, accessibility, security, testing, and maintainability.

## Current Status
Planned. Discovery and initial project setup are in progress. Features described here are product goals and not yet claimed as implemented.
